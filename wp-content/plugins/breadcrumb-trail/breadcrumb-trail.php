...
// CM: changes to default:
	$defaults['separator'] = '<span class="breadcrumb-sep">/</span>';
	$defaults['before'] = '<b class="breadcrumb-title">' . __('You\'re in:', 'breadcrumb_trail') . '</b>';
	$defaults['show_home'] = false;
	$defaults['echo'] = false;
